...
//Публичные ключи
export const GOOGLE_CLIENT_ID: string = "55121685745-c31lj4mjqtrfobfthu3i8p3l1gau4bkf.apps.googleusercontent.com"; // публичный ключ от google console для oauth
//фронтдев мод
